...
struct Graph
{
    // Use a map with a set instead of a vector
...
{
    Graph achievementGraph;
    // Add achievement dependencies
    achievementGraph.addEdge("First Win", "High Scorer");
    achievementGraph.addEdge("Hint Master", "Quick Thinker");
